...
const rootReducer = combineReducers({
    ...
    productReducer,  // productReducer : productReducer - using short hand
    cartReducer,    // cartReducer : cartReducer - using short hand
    couponReducer // couponReducer :-using short hand
