...
class Vaccination
{
    constructor (vaccine_name, price)
    {
        this.vaccine_name = vaccine_name,
        this.price = price
    }

    Book_a_Slot = function ()
    {
        return this.vaccine_name + this.price
    }
}

let vaccObj = new Vaccination("Pfizer", 80);

console.log(vaccObj.Book_a_Slot()); 
